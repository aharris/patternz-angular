<div class="bs-docs-section">
  ...
  <p class="lead">Bootstrap includes a responsive, mobile first fluid grid system that appropriately scales up to 12 columns as the device or viewport size increases. It includes <a href="#grid-example-basic" ng-click="gotoAnchor('grid-example-basic'); $event.preventDefault()">predefined classes</a> for easy layout options, as well as powerful <a href="#grid-styl" ng-click="gotoAnchor('grid-styl'); $event.preventDefault()">mixins for generating more semantic layouts</a>.</p>
...
<div class="zero-clipboard"></div><div class="highlight"><pre><code class="language-scss" data-lang="scss"><span class="cm">/* Extra small devices (phones, less than 768px) */</span>
...
<span class="k">@media</span> <span class="o">(</span><span class="nt">min-width</span> <span class="o">$</span><span class="nt">screen-sm-min</span><span class="o">)</span><br/> <span class="nc">...</span>

<span class="cm">/* Medium devices (desktops, 992px and up) */</span>
<span class="k">@media</span> <span class="o">(</span><span class="nt">min-width</span> <span class="o">$</span><span class="nt">screen-md-min</span><span class="o">)</span><br/> <span class="nc">...</span>

<span class="cm">/* Large devices (large desktops, 1200px and up) */</span>
<span class="k">@media</span> <span class="o">(</span><span class="nt">min-width</span> <span class="o">$</span><span class="nt">screen-lg-min</span><span class="o">)</span><br/> <span class="nc">...</span></code></pre></div>
...
<div class="zero-clipboard"></div><div class="highlight"><pre><code class="language-scss" data-lang="scss"><span class="k">@media</span> <span class="o">(</span><span class="nt">max-width</span> <span class="o">$</span><span class="nt">screen-xs-max</span><span class="o">)</span><br/> <span class="nc">...</span>
<span class="k">@media</span> <span class="o">(</span><span class="nt">min-width</span> <span class="o">$</span><span class="nt">screen-sm-min</span><span class="o">)</span> <span class="nt">and</span> <span class="o">(</span><span class="nt">max-width</span> <span class="o">$</span><span class="nt">screen-sm-max</span><span class="o">)</span><br/> <span class="nc">...</span>
<span class="k">@media</span> <span class="o">(</span><span class="nt">min-width</span> <span class="o">$</span><span class="nt">screen-md-min</span><span class="o">)</span> <span class="nt">and</span> <span class="o">(</span><span class="nt">max-width</span> <span class="o">$</span><span class="nt">screen-md-max</span><span class="o">)</span><br/> <span class="nc">...</span>
<span class="k">@media</span> <span class="o">(</span><span class="nt">min-width</span> <span class="o">$</span><span class="nt">screen-lg-min</span><span class="o">)</span><br/> <span class="nc">...</span></code></pre></div>
...
<div class="zero-clipboard"></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"row"</span><span class="nt">&gt;</span>
...
<div class="zero-clipboard"></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"container-fluid"</span><span class="nt">&gt;</span>
<span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"row"</span><span class="nt">&gt;</span>
...
<span class="nt">&lt;/div&gt;</span>
<span class="nt">&lt;/div&gt;</span></code></pre></div>
...
<div class="zero-clipboard"></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="c">&lt;!-- Stack the columns on mobile by making one full-width and the other half-width --&gt;</span>
<span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"row"</span><span class="nt">&gt;</span>
...
<h3 id="grid-styl">Stylus mixins and variables</h3>
<p>In addition to prebuilt grid classes for fast layouts, Bootstrap includes Less variables and mixins for quickly generating your own simple, semantic layouts.</p>

<h4>Variables</h4>
<p>Variables determine the number of columns, the gutter width, and the media query point at which to begin floating columns. We use these to generate the predefined grid classes documented above, as well as for the custom mixins listed below.</p>
<div class="zero-clipboard"></div><div class="highlight"><pre><code class="language-scss" data-lang="scss"><span class="k">$grid-columns</span><span class="nd">:</span>              <span class="nt">12</span><span class="p">;</span>
